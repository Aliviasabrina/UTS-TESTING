...
def create_test_cart(cart_id):
    cart = Cart(id=cart_id, coupon_code='GIVEAWAY_COUPON', shipping_fee=20.0, subtotal=80.0, grand_total=90.0)
    cart_item = CartItem(product_id=1, qty=5, item_price=40.0)
